        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              ...
              {analysis.exchange_code && (
                <span className="text-xs text-blue-300 block mt-0.5">{analysis.exchange_code}</span>
              )}
              {analysis.status === 'ARCHIVED' && (
                <span className="text-xs px-2 py-1 bg-slate-500/20 text-slate-300 rounded-full inline-block mt-1">
                  Archived
                </span>
              )}
            </div>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              className="p-2 rounded-full bg-white/10 text-blue-300 hover:bg-white/20 transition-all md:hover:bg-white/20"
              title="Edit"
            >
