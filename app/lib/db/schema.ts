...
export const tradeAnalyses = sqliteTable('trade_analyses', {
  ...
  entry_type: text('entry_type').default('STRICT'),
  entry_low: real('entry_low'),
  entry_high: real('entry_high'),
  ...
  risk_reward_ratio_low: real('risk_reward_ratio_low'),
  risk_reward_ratio_high: real('risk_reward_ratio_high'),
...
export const positionActionPlans = sqliteTable('position_action_plans', {
  ...
  buy_shares: real('buy_shares'),
  entry_price: real('entry_price'),
  fees: real('fees'),
  new_average_cost: real('new_average_cost'),
  new_total_shares: real('new_total_shares'),
  last_dividend_per_share: real('last_dividend_per_share'),
  projected_dividend: real('projected_dividend'),
  previous_dividend: real('previous_dividend'),
  notes: text('notes'),
